...
<form name='drdo'>
	...
	<table id='inwardTable'>
		<tr>
			...
			<td>Gate Pass No.</td>
			<td><input type='text' name='gate' class='textB' value='-'  onblur="t(this)"/></td>
			<td style='width:50px;'></td>
			<td>Report No.</td>
		...
		<tr>
			...
			<td style='width:50%'>
				<table class='innTab'>
					...
					<td class='inTabDesign'>BOM QTY</td>
					<td><input type='text' name='bomqty'  style='width:200px'  autocomplete="off"/></td>
					</tr>
	...
	<table class='innTab'>
		<tr>
			...
			<td>
				<input type='text' name='batch' id='bctext' style='width:200px' autocomplete="off"  />
				
				<input type='button' value='ADD+' id='bcbtn' onclick='nextBatch(this.value)'/>
			</td>
		</tr>
	...
	<input type="hidden" name="inwardsec" value="general">

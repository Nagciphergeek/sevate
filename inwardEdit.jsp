...
<hr>
<hr>
<form name='drdo' action='InwardEdit' method='post'>
	...
	<%
		...
		if(rs1.next()){
			rs=stmt.executeQuery("select * from bcnot where pid='"+rs1.getInt(1)+"' AND sys='"+sys+"'");// 
			while(rs.next()){
			%>
	...
	<div id='saveBtn'><input type='button' value='SAVE' onclick='confirmEditDetails()'/></div>
</form>

...
<%
	...
	ResultSet rs=stmt.executeQuery("select * from bom where section='"+section+"' AND dept='"+dept+"' AND system='"+sys+"' AND material not in(select material from bdlreq where missile='"+miss+"' AND section='"+section+"' AND dept='"+dept+"' AND system='"+sys+"') AND material not in(select material from issue"+sys+" where missile='"+miss+"' AND section='"+section+"' AND dept='"+dept+"')");
	ResultSet rs1=null;
...
<input type='hidden' name='casrequest' value='request'/>
<table id='listAll'>
	<tr>
